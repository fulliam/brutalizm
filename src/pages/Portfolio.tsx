      ...
      >
        ...
        {hasMore && (
          <div ref={ref} className="flex justify-center mt-12">
            {loading ? (
              <motion.div
                className={`font-mono text-xl ${isDark ? "text-brutal-yellow" : "text-brutal-red"}`}
              ...
              <div className={`font-mono ${isDark ? "text-brutal-red" : "text-brutal-blue"}`}>СКРОЛЛЬ ДЛЯ ЗАГРУЗКИ</div>
            )}
          </div>
        )}
        ...
        {!hasMore && (
          <motion.div
            className={`text-center mt-12 font-anton text-2xl ${isDark ? "text-brutal-pink" : "text-brutal-purple"}`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
