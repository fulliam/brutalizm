      ...
      <div className="text-center">
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link href="/portfolio" className={`brutal-button block w-fit mx-auto ${isDark ? "brutal-button-dark" : ""}`}>
              <a className="brutal-button">СМОТРЕТЬ РАБОТЫ</a>
            </Link>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            >
              <a className="brutal-button">РЕЗЮМЕ</a>
            </Link>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            >
              <a className="brutal-button">КОНТАКТЫ</a>
            </Link>
          </motion.div>
        </motion.div>
